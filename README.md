...
# Elastic Export MyBestBrand.de Plugin for plentymarkets 7

This is the elastic export MyBestBrand.de plugin for plentymarkets 7 which extends the list of possible export formats. 
